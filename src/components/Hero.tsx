      ...
      <div className="container flex flex-col-reverse md:flex-row items-center gap-8 md:gap-16">
        <div className="flex-1 animate-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="mb-6 max-w-xl">
            <p className="text-lg md:text-xl text-muted-foreground mb-4">
              Building robust systems and scalable architecture with modern
              technologies
            </p>
            <p className="text-sm md:text-base w-full md:w-[450px] h-6 overflow-hidden">
              const developer = new BackendEngineer("Dharmil Parekh");
            </p>
          </div>
        ...
        <div className="flex-1 flex justify-center">
          <div className="relative">
            ...
            <div
              className="absolute top-1/4 -right-4 bg-background/80 backdrop-blur-sm p-3 rounded-lg border border-primary/20 shadow-md animate-float"
              style={{ animationDelay: "1s" }}
            >
              <Server className="h-6 w-6 text-primary" />
            </div>
            <div
              className="absolute bottom-1/4 -left-4 bg-background/80 backdrop-blur-sm p-3 rounded-lg border border-primary/20 shadow-md animate-float"
